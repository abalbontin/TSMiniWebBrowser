Pod::Spec.new do |s|
  ...
  s.platform     = :ios
  s.license      = 'MIT'
  s.summary      = 'An in-app web browser control for iOS apps. Modificado por abalbontin'
  s.homepage     = 'https://github.com/tonisalae/TSMiniWebBrowser'
  s.author       = { 'Toni Sala' => 'tonisalae@gmail.com' }
  s.source       = { :git => 'https://github.com/abalbontin/TSMiniWebBrowser.git', :tag => 'version_1.0.1' }
